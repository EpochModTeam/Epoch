...
// General
	ryanZombiesEnabled = "true";				// Set it to "false", when you running RyanZ Mod, but do not want to use the Epoch Scripts for it
...
// Antagonist spawn
	...
	// suppress these units from spawning near Jammers / Traders
