...
class build_upgrade
{
	...
	action = "";
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\build_upgrade.paa";
	tooltip = "Upgrade";
...
class build_remove
{
	...
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\build_remove.paa";
	tooltip = "Remove";
};
class build_move
{
	...
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\build_move.paa";
	tooltip = "Move";
};
...
class veh_lock
{
	...
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\pad_cannot_lock.paa";
	tooltip = "Lock";
};
class veh_unLock
{
	...
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\pad_can_unlock.paa";
	tooltip = "Unlock";
};
...
class tra_talk
{
	...
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\talk_blue.paa";
	tooltip = "Talk";
};
class tra_shop
{
	...
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\krypto.paa";
	tooltip = "Shop";
};
...
class pack_lockbox
{
	...
	icon = "x\addons\a3_epoch_icons\Data\UI\buttons\build_pack.paa";
